...
namespace cam_rewrite
{
    public partial class Form1 : Form
    {
        ...
        void DisplaySpeed()
        {
            ...
            {
                speedLB.Text = $"speedX: {speedX} pixel/frame";
                speedYLB.Text = $"speedY: {speedY} pixel/frame";
                totalLB.Text = $"total: {speed} pixel/frame";
            });
        ...
        //the hardest part of the programm and it made me cry 24 times (update as you go)
